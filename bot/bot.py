...
def get_ai_recommendation(prompt, city_name, search_term=""):
    ...
    try:
        ...
        query = search_term or city_name
...
3. Не повторяй места. Не выдумывай цены, часы работы и факты, если не уверен.
4. Не обещай точный прогноз дальше доступного горизонта.
